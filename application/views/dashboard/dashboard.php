                        ...
                        <div class="card">
                            <div class="stat-widget-two card-body">
                                <div class="stat-content">
                                    <div class="stat-text">Today Iuran </div>
                                    <div class="stat-digit"> <i class="fa fa-money"></i><?="Rp " . number_format($Total_Iuran->grand_total_iuran)?></div>
                                </div>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="card">
                            <div class="stat-widget-two card-body">
                                <div class="stat-content">
                                    ...
                                    <div class="stat-digit"> <i class="fa fa-users"></i><?=$Total_Warga?></div>
                                </div>
                            </div>
                        </div>
                    </div>
